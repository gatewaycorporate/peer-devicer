 ...
 */
export const FREE_TIER_EDGE_TYPES = [
    'shared_user',
    'shared_ip_subnet',
];
// ── Signal extraction ─────────────────────────────────────────
 ...
 *                   consumed.
 */
export function extractPeerSignals(context, incoming) {
    const signals = {};
    // ── userId ─────────────────────────────────────────────────
    if (context.userId) {
 ...
 * are evaluating from.
 */
export function buildEdgeShape(input) {
 ...
 */
export function activeSignalEntries(signals, enabledTypes, isFreeTier) {
